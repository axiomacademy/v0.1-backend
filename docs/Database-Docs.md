# Database Documentation :notebook_with_decorative_cover:
The database of choice for the Axiom backend is [Postgres](https://www.postgresql.org/). This section outlines some of the decisions surrounding database design and also explains what each table in the database does.
